        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
					...
					<div>
						<form action="/admin/branchUpdate" method="post"
							...
							<div class="form-group">
								<label for="name">지점명:</label> <input type="text"
									class="form-control" id="name" value="${branch.name}"
									name="name">
							</div>
							<div class="form-group">
								<label for="addr">지점주소:</label> <input type="text"
									class="form-control" id="addr" value="${branch.addr}"
									name="addr">
							</div>
							<div class="form-group">
								<label for="phone">전화번호:</label> <input type="text"
									class="form-control" id="phone" value="${branch.phone}"
									name="phone">
							</div>
							<div class="form-group">
							...
							<button type="submit" class="submit" id="update">수정</button>
						</form>
					</div>
				</main>
            </div>
